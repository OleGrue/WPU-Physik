...
int repeat = 300;     // How many times should we loop before stopping? (0 for no stop)
...
void crossFade(int color[3]) {
  ...
  for (int i = 0; i <= 1020; i++) {
    ...
    if (digitalRead(input_aufzug) == false){
